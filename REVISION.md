...
- (2026-01-11) [ready_tail_tzs](./.gila/todo/ready_tail_tzs/ready_tail_tzs.md) Added `--owner` flag to the `todo` command to set the owner of a task
- (2026-01-11) [ready_tail_tzs](./.gila/todo/ready_tail_tzs/ready_tail_tzs.md) Added `gila todo --edit` to open the task description file in the editor after creating the task
